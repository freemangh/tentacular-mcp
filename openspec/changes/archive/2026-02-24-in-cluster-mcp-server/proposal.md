...
- `gvisor-sandbox`: Check gVisor RuntimeClass availability, apply gVisor annotation to a namespace, and run a verification pod to confirm sandbox isolation is functional (tools: `gvisor_check`, `gvisor_apply`, `gvisor_verify`)
